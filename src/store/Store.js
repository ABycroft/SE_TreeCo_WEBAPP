                ...
                <TreesConsumer>
                    {(value) => (
                        <div className="text-right">
                            <button className="btn mx-1" onClick={value.sortByPrice} variant="light">Sort by Price</button>
                            <button className="btn mx-1" onClick={value.sortByName} variant="light">Sort by Name</button>
                        </div>
                    )}
                </TreesConsumer>
                <TreeList />
